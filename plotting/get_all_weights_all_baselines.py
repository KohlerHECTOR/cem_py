...
flattened_reinforce = weights_reinforce.reshape(
    weights_reinforce.shape[0] * weights_reinforce.shape[1], -1
)
all_weights.append(flattened_reinforce)

# Flatten REINFORCE with baseline weights
flattened_reinforce_bs = weights_reinforce_bs.reshape(
    weights_reinforce_bs.shape[0] * weights_reinforce_bs.shape[1], -1
)
