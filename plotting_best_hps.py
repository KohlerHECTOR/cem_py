...
def plot_data(data_paths, line_style, color, label, ax1, ax2):
    ...
    for data_path in data_paths:
        try:
            ...
            all_walltimes.append(data.get("walltime", np.zeros_like(data["train_scores"])))
    ...
    if all_train_scores:
        ...
        ax1.plot(train_samples_mean, train_mean, linestyle=line_style, color=color, linewidth=4, label=label)
        ...
        ax2.plot(walltime_mean, train_mean, linestyle=line_style, color=color, linewidth=4, label=label)
